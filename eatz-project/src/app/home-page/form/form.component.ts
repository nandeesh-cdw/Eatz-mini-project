...
import { FORM_CONSTANTS } from 'src/app/core/constants/constants';
@Component({
  selector: 'app-form',
...
export class FormComponent {
  //constants 
  title:string = FORM_CONSTANTS.title;
  errorMessage: string =FORM_CONSTANTS.error_message;
  confirmMessage: string =FORM_CONSTANTS.confirm_message;
  close: string =FORM_CONSTANTS.close;
